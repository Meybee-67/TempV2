      ...
      children: <Widget>[
        ...
        Positioned(
          ...
          child:Container(
            ...
            majorTickStyle: LinearTickStyle(length: 10, thickness: 1.25, color: Colors.black),
            minorTickStyle: LinearTickStyle(length: 5, thickness: 1, color: Color.fromARGB(219, 214, 214, 214)),
            barPointers: [LinearBarPointer(value: double.parse(tempR),color:Colors.blue)],
          )
          )
          ),
        Positioned(
